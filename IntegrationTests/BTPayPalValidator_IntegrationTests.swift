...
class BTPayPalValidator_IntegrationTests: XCTestCase {
    ...
    var validatorClient: BTPayPalValidatorClient!
    ...
    override func setUp() {
        super.setUp()
        self.validatorClient = BTPayPalValidatorClient(accessToken: self.uat)
    }
