Pod::Spec.new do |s|
  s.name             = "BraintreePayPalValidator"
  s.version          = "0.0.1"
  s.summary          = "Braintree PayPal Validator component for use with the Braintree iOS SDK"
  s.description      = <<-DESC
  ...
  s.source_files  = "BraintreePayPalValidator/**/*.{h,m}"
  s.public_header_files = "BraintreePayPalValidator/Public/*.h"
